...
bpath = '/share/das/dist/carlos.bastarz/sandbox/SMNAMonitoringApp/cron_scripts/jo'
...
df_xc50 = get_df_Nobs(datai, dataf, 'xc50', 'df_xc50')
#df_xc50_new = get_df_Nobs(datai, dataf, 'preOper_new', 'df_xc50_new')
df_egeon = get_df_Nobs(datai, dataf, 'egeon', 'df_egeon')
...
dfs = pd.concat([df_xc50, df_egeon], axis=1, keys=([df_xc50.name, df_egeon.name]))
#dfs = pd.concat([df_xc50, df_xc50_new, df_egeon], axis=1, keys=([df_xc50.name, df_xc50_new.name, df_egeon.name]))
...
#
#df_xc50.loc[df_xc50['Observation Type'] == 'surface pressure'].reset_index(drop=True)
#
#
## In[13]:
#
...
#
#df_xc50.loc[df_xc50['Observation Type'] == 'surface pressure'].loc[df_xc50['Iter'] == 'OMF'].reset_index(drop=True)
#
#
## In[14]:
#
...
#
#df_xc50.loc[df_xc50['Observation Type'] == 'surface pressure'].loc[df_xc50['Iter'] == 'OMF'].set_index('Date').at_time(str('00:00:00')).reset_index(drop=False)
#
#
## In[22]:
#
#
#df_xc50.set_index(['Date']).loc['2023-01-01':'2023-02-01']
#
#
## In[21]:
#
#
#df_egeon.set_index(['Date']).loc['2023-01-01':'2023-02-01']
#
#
## In[23]:
#
#
#df_xc50.loc[df_xc50['Observation Type'] == 'wind'].loc[df_xc50['Iter'] == 'OMF'].set_index('Date').loc['2023-01-01':'2023-02-01'].at_time(str('00:00:00')).reset_index(drop=False)
#
#
## In[24]:
#
#
#df_egeon.loc[df_egeon['Observation Type'] == 'wind'].loc[df_egeon['Iter'] == 'OMF'].set_index('Date').loc['2023-01-01':'2023-02-01'].at_time(str('00:00:00')).reset_index(drop=False)
#
#
## In[ ]:
#
